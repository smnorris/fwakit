...
Note that TRUE is returned also if the codes are equivalent.

eg:

fwakit=# SELECT fwa_upstream('100.100000'::ltree, '100.100000'::ltree, '100.100000.000100'::ltree, '100.100000.000100'::ltree);
 fwa_upstream
--------------
 t
(1 row)

fwakit=# SELECT fwa_upstream('100.100000'::ltree, '100.100000'::ltree, '100.100000'::ltree, '100.100000'::ltree);
 fwa_upstream
--------------
 t
(1 row)
