...
CREATE INDEX IF NOT EXISTS ON whse_basemapping.fwa_streams_20k_50k_wsc (watershed_code_50k);
CREATE INDEX IF NOT EXISTS ON whse_basemapping.fwa_streams_20k_50k_wsc (fwa_watershed_code_20k);