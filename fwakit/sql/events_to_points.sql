...
SELECT events.*,
       ST_Line_Interpolate_Point(streams.geom, ROUND(CAST((events.downstream_route_measure - streams.downstream_route_measure) / streams.length_metre AS NUMERIC), 5)) AS geom
